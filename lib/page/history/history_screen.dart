            ...
            for (var d = 1; d <= daysInMonth; d++)
              _DayCell(
                ...
                adherence: controller
                    .adherenceFor(DateTime(month.year, month.month, d)),
                ...
                isToday: month.year == today.year &&
                    ...
                    d == today.day,
                onTap: () =>
                    _openDetail(context, DateTime(month.year, month.month, d)),
              ),
          ],
        ),
      ],
...
class _DayCell extends StatelessWidget {
  ...
  Color get _tint {
    ...
    return AppPalette.emerald
        .withValues(alpha: (0.12 + a * 0.35).clamp(0.0, 0.55));
  }
    ...
    return GlassSheet(
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            // The frozen totals for this exact day -- not "today" reused, a
            // real historical record -- so this is the same ring the day
            // showed while it was still today, not a live recomputation.
            Center(
              child: CalorieRing(
                size: 160,
